...
- Dev: Export block settings to an external global `wc.blockSettings` that can be reliably used by extensions by enqueuing their script with the `my-block-settings` as the handle. #903
...
- **BREAKING:** Remove the `my-pb/v3/*` endpoints in favor of new core `my-blocks/v1/*` endpoints
